...
**数据**：`results/{baseline,ratio_099,...}/run_{1,2,3}/` + `results/summary.csv`
...
![trajectory_family](results_py/trajectory/trajectory_family.png)
...
![acceptance_rate](results_py/acceptance_rate/acceptance_rate.png)
...
scripts/greedy_subset.py       # 正向贪心添加框架
